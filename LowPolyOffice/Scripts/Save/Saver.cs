...
namespace Office.Save {
    public abstract class Saver : MonoBehaviour {
        ...
        private SceneChanger sceneController;    // Reference to the SceneController so that this can subscribe to events that happen before and after scene loads.
