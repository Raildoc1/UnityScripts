...
public class ConditionEditor : Editor
{
    ...
    private const string conditionPropSatisfiedName = "_isSatisfied";      // Name of the field that represents whether or not the Condition is satisfied.
    ...
    protected virtual void AllConditionsAssetGUI()
    {
    ...
    protected virtual void ConditionAssetGUI()
    {
        EditorGUILayout.BeginHorizontal(GUI.skin.box);
        EditorGUI.indentLevel++;
    ...
    protected static void SetHash(Condition condition)
    {
