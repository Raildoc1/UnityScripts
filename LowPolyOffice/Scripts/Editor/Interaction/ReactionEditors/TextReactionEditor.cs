...
public class TextReactionEditor : ReactionEditor {
    ...
    private const string textReactionPropMessageName = "textUniqueName";
    ...
    protected override void DrawReaction() {
        ...
        EditorGUILayout.TextField("Text Unique Name", GUILayout.Width(EditorGUIUtility.labelWidth - areaWidthOffset));
